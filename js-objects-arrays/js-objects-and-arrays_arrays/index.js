...
exampleArray.push(2);
exampleArray.unshift("Test-String");
console.log("New exampleArray after addition:", exampleArray);
...
const myFruits = ["apple", "banana", "peach"];
nestedArray.push(myFruits);
console.log("nestedArray after addition:", nestedArray);
...
fruits[0] = "mango";
console.log("fruits array after the change:", fruits);
...
console.log("The nestedNumber is", nestedNumber);
...
console.log("petswithPush after pushing:", petsWithPush);
...
fruitsWithPop.pop();
console.log("fruitsWithPop after popping:", fruitsWithPop);
...
console.log(
  "unshiftedPets after adding an element to the first position:",
  unshiftedPets
);
...
shiftedFruits.shift();
console.log("shiftedFruits array after removing its first item", shiftedFruits);
