...
export const [name, price, quality] = item;
console.log(price, name, price, quality);
console.log(name);
...
console.log(lastNameOfChris, firstNameOfChris, ageOfChris);
...
export const [student1, [student2, student3], [student4, student5]] =
  nestedStudents;
console.log(student1, student3, student5);
...
export const result = add(10, ...values); // Spread values inside this function call
console.log(result);
